...
# ── Main UI ───────────────────────────────────────────────────────────────────
# ── VIBES shortcuts (artist quick-launch) ─────────────────────────────────────
VIBES = {
    "lana":    {"artist": "Lana Del Rey",     "mood": "idle",    "face": "(◕‿◕)っ", "idx": 0},
    "beegees": {"artist": "Bee Gees",         "mood": "done",    "face": "٩(◕‿◕｡)۶","idx": 6},
    "mj":      {"artist": "Michael Jackson",  "mood": "working", "face": "(ง •_•)ง", "idx": 10},
    "chopin":  {"artist": "Chopin",           "mood": "sleepy",  "face": "(－_－)zZ", "idx": 15},
    "billie":  {"artist": "Billie Eilish",    "mood": "hungry",  "face": "(＾་།＾)",  "idx": 20},
    "cas":     {"artist": "CAS",              "mood": "idle",    "face": "( ᵕ̈ )っ",  "idx": 25},
}

def sync_mood(mood, artist="Station", track="Cosmic Mix"):
    """Write mood + now_playing for widget/desktop integration."""
    import os
    os.makedirs("data", exist_ok=True)
    try:
        open("data/now_playing.txt","w").write(f"{artist} - {track}")
        open("data/kirby_mood.txt","w").write(mood)
    except Exception:
        pass
